...
//  Accessing the modal element in html and paste it  make it responsivble

// Add Event listeners to listen to the submit event of the modal.
const getmodalEle = document.getElementById('postForm'); // Select the modal element with id "postmodal"

getmodalEle.addEventListener('submit', (event) => { // refer to the  submit event
